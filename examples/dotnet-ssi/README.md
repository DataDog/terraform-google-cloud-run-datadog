# Example: Deploying an Instrumented .NET Cloud Run Service with Datadog SSI
...
| <a name="input_name"></a> [name](#input\_name) | The name of the Cloud Run service | `string` | `"cloud-run-tf-example-dotnet-ssi"` | no |
