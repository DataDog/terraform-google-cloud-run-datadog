...
This example demonstrates how to use the `terraform-google-cloud-run-datadog` wrapper module to fully instrument a sample Python application with logs, metrics, and tracing using Datadog.
